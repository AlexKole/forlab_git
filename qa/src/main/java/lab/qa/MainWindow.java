...
import lab.pages.AbstractPage;
import lab.pages.LoginPage;
...
public class MainWindow{
	...
	public MainWindow(WebDriver driver, String url) {
		...
		if (driver.findElement(By.id("js-mailbox-exit")).isDisplayed())
			driver.findElement(By.id("js-mailbox-exit")).click();
